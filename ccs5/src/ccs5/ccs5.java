...
{ 
	...
	{ 
        ...
        //Method to calculate the completion time`
        static void  findCompletionTime(int processes[], int n, int at[],
							int bt[], int wt[], int tat[]) 
	{ 
                   
//         (processes[] + quantum * at[])* bt[];
//         (processes[]+ quantum)at[] * bt[];
//         4bt[] + (processes[] * at[]) +  (quantum * at[] );
//         (bt[] * processes[] * at[] ) + quantum;
	...
	{ 
		...
		int burst_time[] = {5, 10, 20, 25, 30}; 
                
                //for the arrival time
                int arrival_time[] = {0, 0, 0, 0, 0};
